...
import { isWorkerActive } from "./backend/cloudflareWorker/cloudflareWorker";
import {
  extensionInfo,
...
// Check worker availability on startup
isWorkerActive().catch(() => {
  // Worker not available, will fall back to extension or proxy
});
