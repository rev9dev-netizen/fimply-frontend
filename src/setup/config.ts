...
interface Config {
  ...
  CLOUDFLARE_WORKER_API_KEY: string;
}
...
export interface RuntimeConfig {
  ...
  CLOUDFLARE_WORKER_API_KEY: string | null;
}
...
const env: Record<keyof Config, undefined | string> = {
  ...
  CLOUDFLARE_WORKER_API_KEY: import.meta.env.VITE_CLOUDFLARE_WORKER_API_KEY,
};
...
export function conf(): RuntimeConfig {
  return {
    ...
    CLOUDFLARE_WORKER_URL: getKey("CLOUDFLARE_WORKER_URL"),
    CLOUDFLARE_WORKER_API_KEY: getKey("CLOUDFLARE_WORKER_API_KEY"),
  };
}
